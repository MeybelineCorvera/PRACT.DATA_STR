...
fun main(args: Array<String>) {
    ...
    val mediumList = (1..10000).toList().shuffled().toIntArray()
    val orderedList = (1..100000).toList().toIntArray()

    println("Tiempos de ejecución comparativa")

    val bubble = measureSortTime(::bubbleSort, smallList)
    val insertion = measureSortTime(::insertionSort, smallList)
    val selection = measureSortTime(::selectionSort, smallList)


    println("Bubble Sort: $bubble ms")
    println("Insertion Sort: $insertion ms")
    println("Selection Sort: $selection ms")
}